...
export default function BannerDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (error || !banner) return <ErrorView message={error} onBack={() => router.push('/playground')} />;

  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto py-8 px-4">
        <button onClick={() => router.push('/playground')} className="mb-6 text-sm text-gray-500 hover:text-gray-800 transition-colors flex items-center gap-1">
